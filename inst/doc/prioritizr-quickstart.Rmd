...
This vignette is a simple, quickstart guide, for full details on this package, consult the complete vignette with `vignette("prioritizr")`. What follows are some simple example of how this package can be used to solve conservation prioritization problems.
...
<img src="figures/quickstart_generate-data-1.png" title="plot of chunk generate-data" alt="plot of chunk generate-data" style="display: block; margin: auto;" />
...
<img src="figures/quickstart_generate-data-2.png" title="plot of chunk generate-data" alt="plot of chunk generate-data" style="display: block; margin: auto;" />
...
<img src="figures/quickstart_solutions-1.png" title="plot of chunk solutions" alt="plot of chunk solutions" style="display: block; margin: auto;" />

```r
plot_selection(cost, mc_results$x, title = "Maximum Cover Solution")
```

<img src="figures/quickstart_solutions-2.png" title="plot of chunk solutions" alt="plot of chunk solutions" style="display: block; margin: auto;" />
