...
output:
  html_document:
    ...
    theme: united
vignette: >
  %\VignetteIndexEntry{"prioritizr: Quickstart Guide"}
...
<img src="figures/quickstart_solutions-3.png" title="plot of chunk solutions" alt="plot of chunk solutions" style="display: block; margin: auto;" />
